...
parser.add_argument('--estate_id', type=str, required=True, help='The ID of the estate to add data to')
parser.add_argument('--action', type=str, choices=['add', 'clear'], default='add', help='Action to perform (add or clear data)')
parser.add_argument('--type', type=str, choices=['all', 'transactions', 'notices', 'members'], default='all', 
